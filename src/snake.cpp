...
void Snake::UpdateHead() {
  ...
  head_x = static_cast<float>(fmod(head_x + static_cast<float>(grid_width), grid_width));
  head_y = static_cast<float>(fmod(head_y + static_cast<float>(grid_height), grid_height));
}
